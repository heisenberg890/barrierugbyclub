...
<div class="row pageHeaderRow">
 	<div class="large-10 medium-10 small-10 columns">
 		<p class="pageHeaderColumn">U-16 Boys</p>
 	</div>
...
?>
    	...
    	<div class="small-12 medium-12 large-12 columns">
    		<p class="teamPageContent">Under 16 practices are Monday and Wednesday evenings at the Barrie Sports Complex - Jim Hamilton Memorial Field.<br />
    			Under 16 games are Saturday mornings at the Barrie Sports Complex - Jim Hamilton Memorial Field (travel required for away games).<br />The Under 16 season runs from May to end of August.</p>
    		<p class="contactPageContent">Contact: <a href="mailto:u16boys@barrierugbyclub.com"><?php include("partials/coaches/u16b.php"); ?> | u16boys@barrierugbyclub.com</a></p>
    	</div>
    </div>
    
        <div class="row pricingSpacing">
        	<p class="registerHeader">U16 Boys Team</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		<p class="pricingHeader1">Under 16 Boys</p>
    		<p class="pricingContent">Players Born In <?php echo date("Y")-16; ?> and <?php echo date("Y")-15; ?></p>
    	</div>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		...
    		<p class="pricingContent"><a href="mailto:u16boys@barrierugbyclub.com">Brandon Kirkwood</a></p>
    	</div>
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
		...
		<ul class="accordion" data-accordion>
		  <li class="accordion-navigation">
		    ...
		    <div id="panel1a" class="content">
		    	<p class="accordionFaqContent">Under 16 practices are Monday and Wednesday evenings at the Barrie Sports Complex - Jim Hamilton Memorial Field. Under 18 boys practices are Tuesday and Thursday evenings at the Barrie Sports Complex - Jim Hamilton Memorial Field. Under 18 girls practices are Tuesday evenings at the Barrie Sports Complex - Field 1</p>
		    </div>
		  </li>
		  <li class="accordion-navigation middleAccordions">
		    <a href="#panel2a">+ When are the games?</a>
		    <div id="panel2a" class="content">
		    	<p class="accordionFaqContent">Under 16 games are Saturday mornings at the Barrie Sports Complex - Jim Hamilton Memorial Field (travel required for away games).</p>
		    </div>
		  </li>
		  <li class="accordion-navigation smallBottomAccordion">
		    <a href="#panel3a">+ Is there a contact</a>
		    <div id="panel3a" class="content">
		    	<p class="accordionFaqContent"><a href="mailto:u16boys@barrierugbyclub.com">Brandon Kirkwood</a></p>
		    </div>
		  </li>
		</ul>
	</div>
...
<p class="accordionFaqContent">The Under 16 season runs from May to end of August.</p>
		    </div>
		  </li>
		  <li class="accordion-navigation middleAccordions">
