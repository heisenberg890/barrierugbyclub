...
<div class="row pageHeaderRow">
 	<div class="large-10 medium-10 small-10 columns">
 		<p class="pageHeaderColumn">U-14 Girls</p>
 	</div>
...
?>
    	...
    	<div class="small-12 medium-12 large-12 columns">
    		...
    		<p class="contactPageContent">Contact: <a href="mailto:u14girls@barrierugbyclub.com"><?php include("partials/coaches/u14g.php"); ?> | u14boys@barrierugbyclub.com</a></p>
    	</div>
    </div>
    
        <div class="row pricingSpacing">
        	<p class="registerHeader">U14 Girls Team</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		<p class="pricingHeader1">Under 14 Girls</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		...
    		<p class="pricingContent"><a href="mailto:u14boys@barrierugbyclub.com"><?php include("partials/coaches/u14g.php"); ?></a></p>
    	</div>
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
		...
		<ul class="accordion" data-accordion>
		  ...
		  <li class="accordion-navigation smallBottomAccordion">
		    ...
		    <div id="panel3a" class="content">
		    	<p class="accordionFaqContent"><a href="mailto:u14girls@barrierugbyclub.com"><?php include("partials/coaches/u14g.php"); ?></a></p>
		    </div>
		  </li>
		</ul>
	</div>
