...
<div class="row pageHeaderRow">
 	<div class="large-10 medium-10 small-10 columns">
 		<p class="pageHeaderColumn">U-8 Co-Ed</p>
 	</div>
...
?>
    ...
    <div class="row">
    	<div class="small-12 medium-12 large-12 columns">
    		<p class="teamPageContent"> Under 8 practices are Monday and Wednesday evenings at the Barrie Sports Complex - Field 6. Practices Start- May 1
Summer Break- July 10-26<br />
    			Under 8 games are away tournaments held throughout southern Ontario usually the Toronto area.<br />U8 is non-contact.<br />The Under 8 seasons run from May to June, as well as the end of August.</p>
    		<p class="contactPageContent">Contact: <a href="mailto:u8coach@barrierugbyclub.com"><?php include("partials/coaches/u8.php"); ?> | u8coach@barrierugbyclub.com</a></p>
    	</div>
    </div>


    <div class="row pricingSpacing">
    	<p class="registerHeader">U8 Co-Ed Team</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		<p class="pricingHeader1">Under 8 Co-Ed</p>
    		<p class="pricingContent">Players Born in <?php echo date("Y")-8;?> and <?php echo date("Y")-7;?></p>
    	</div>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		...
    		<p class="pricingContent"><a href="mailto:u8coach@barrierugbyclub.com"><?php include("partials/coaches/u8.php"); ?></a></p>
    	</div>
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
		...
		<ul class="accordion" data-accordion>
		  <li class="accordion-navigation">
		    ...
		    <div id="panel1b" class="content">
		    	...
		    	Mondays 6-8 Field 6 Barrie Community Sports Complex<br />
                    Wednesdays 6-8 Field 6 Barrie Community Sports Complex<br />
                    Practices Start- May 1<br />
                    Summer Break- July 10-26
...
<p class="accordionFaqContent">The Under 6 season runs from May to July. The Under 8, 10 and 12 seasons run from May to June, as well as the end of August.</p>
		    </div>
		  </li>
		  <li class="accordion-navigation middleAccordions">
