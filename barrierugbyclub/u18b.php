...
<div class="row pageHeaderRow">
 	<div class="large-10 medium-10 small-10 columns">
 		<p class="pageHeaderColumn">U-18 Boys</p>
 	</div>
...
?>
    	...
    	<div class="small-12 medium-12 large-12 columns">
    		<p class="teamPageContent">Under 18 boys practices Mondays 6-8 Victoria Woods Park, Barrie and Tuesdays 6-8  Field 6 Barrie Community Sports Complex. Practices start June 5th<br />
    			Under 18 boys games are Wednesday evenings at the Barrie Sports Complex - Jim Hamilton Memorial Field (travel required for away games).<br />The Under 18 boys seasons run from June to the end of August.</p>
    		<p class="contactPageContent">Contact: <a href="mailto:u18boys@barrierugbyclub.com"><?php include("partials/coaches/u18b.php"); ?> | u18boys@barrierugbyclub.com</a></p>
    	</div>
    </div>
    
        <div class="row pricingSpacing">
        	<p class="registerHeader">U18 Boys Team</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		<p class="pricingHeader1">Under 18 Boys</p>
    	...
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
    		...
    		<p class="pricingContent"><a href="mailto:u18boys@barrierugbyclub.com"><?php include("partials/coaches/u18b.php"); ?></a></p>
    	</div>
    	<div class="large-2 medium-2 small-12 columns pricingColumn">
		...
		<ul class="accordion" data-accordion>
		  <li class="accordion-navigation">
		    ...
		    <div id="panel1a" class="content">
		    	<p class="accordionFaqContent">Under 18 boys practices are Mondays 6-8 Victoria Woods Park, Barrie and Tuesdays 6-8  Field 6 Barrie Community Sports Complex. Practices start June 5th</p>
		    </div>
		  </li>
		  <li class="accordion-navigation middleAccordions">
		    <a href="#panel2a">+ When are the games?</a>
		    <div id="panel2a" class="content">
		    	<p class="accordionFaqContent">Under 18 boys games are Wednesday evenings at the Barrie Sports Complex - Jim Hamilton Memorial Field (travel required for away games).</p>
		    </div>
		  </li>
		  <li class="accordion-navigation smallBottomAccordion">
		    <a href="#panel3a">+ Is there a contact</a>
		    <div id="panel3a" class="content">
		    	<p class="accordionFaqContent"><a href="mailto:u18boys@barrierugbyclub.com">Brandon Kirkwood</a></p>
		    </div>
		  </li>
		</ul>
	</div>
...
<p class="accordionFaqContent">The Under 18 boys seasons run from June to the end of August.</p>
		    </div>
		  </li>
		  <li class="accordion-navigation middleAccordions">
